...
export default async function ResetPasswordPage() {
  ...
  // Si llegaron aquí sin sesión activa, el link expiró o no se intercambió bien.
    ...
    <main className="min-h-screen grid lg:grid-cols-[1fr_minmax(420px,520px)]">
      ...
      >
        ...
        <div className="relative max-w-md">
          ...
          >
            La próxima vez que entres vas a usar esta contraseña.
          </p>
        </div>
      ...
      <section className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          <Link href="/login" className="inline-flex items-center gap-2 mb-10 lg:hidden">
            <Mark />
            <span
              className="font-[family-name:var(--font-display)] text-2xl tracking-[-0.02em]"
              style={{ color: 'var(--color-ink)' }}
          ...
          <p className="mt-2 text-sm" style={{ color: 'var(--color-muted)' }}>
            Mínimo 8 caracteres. Después te llevamos al panel.
          </p>
