          ...
          {grupos.map(([fecha, lista]) => (
            <section key={fecha}>
              <div className="flex items-baseline gap-3 mb-3">
                ...
                <a
                  href={`/admin/domicilios-programados/imprimir?dia=${fecha}`}
                  target="_blank"
                ...
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden>
                    <path
                      d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-2M6 14h12v8H6z"
                      stroke="currentColor"
                      strokeWidth="1.6"
                      strokeLinecap="round"
