    ...
    >
      ...
      >
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          {/* Direccion + Google Maps (solo domicilio) */}
          ...
          {entrega.notasEntrega ? (
            ...
            >
              <p
                className="text-[0.65rem] uppercase tracking-[0.12em] mb-1"
                style={{ color: '#92400e' }}
              >
                Notas del cliente
              </p>
        ...
        >
          {yaEntregado ? (
            <div
              className="h-12 rounded-[var(--radius-md)] grid place-items-center text-sm font-medium"
            ...
            <div className="space-y-2">
              <div
                className="h-11 rounded-[var(--radius-md)] grid place-items-center text-sm font-medium"
                style={{ background: '#dbeafe', color: '#1e40af' }}
              >
                {esDomicilio ? 'En camino' : 'Listo para recoger'}
              </div>
              <p className="text-[0.7rem] text-center" style={{ color: 'var(--color-muted)' }}>
                Cuando completes la entrega, usa el boton "Entregar" en la tarjeta.
              </p>
            </div>
          ) : (
            <button
              ...
              onClick={marcar}
              disabled={pending}
              className="w-full h-12 rounded-[var(--radius-md)] text-base font-medium disabled:opacity-50"
              style={{ background: colorMarca, color: 'white' }}
            >
              {pending
                ? 'Actualizando...'
